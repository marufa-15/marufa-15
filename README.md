...
* 🧠 Biomedical Signal Processing (MMG & EMG)
* 🤖 Human–Machine Interaction
* 🦾 Rehabilitation Robotics
* 📡 Wearable Sensing Technologies
* 🏗️ Finite Element Analysis (ANSYS)
...
![ANSYS](https://img.shields.io/badge/ANSYS-FEA-yellow?style=for-the-badge)
![Fusion 360](https://img.shields.io/badge/Fusion360-CAD-orange?style=for-the-badge)
...
Arduino • ESP32 • Biomedical Sensors • Rapid Prototyping • 3D Printing
...
| Project                            | Description                                             |
| ---------------------------------- | ------------------------------------------------------- |
| 🦾 Flex Sensor Prosthetic Hand     | Low-cost prosthetic hand with gesture control           |
| 🔊 Acoustic Sentinel               | Airbus Fly Your Ideas 2026 Structural Health Monitoring |
| 💪 Wearable EMG System             | Portable EMG acquisition hardware                       |
| 🧵 Fabric Defect Detection         | Computer Vision for textile inspection                  |
| 📈 Composite Pipeline Analysis     | Burst pressure optimization using ANSYS                 |
...
* Remote Sensing & Environmental Data Analysis
...
> *"Engineering meaningful technologies through research, sensing, and intelligent system design."*
